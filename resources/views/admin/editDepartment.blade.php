                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            {{csrf_field()}}
                                <h6 class="mb-4">update Department </h6>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"  value="{{$department->name}}"  placeholder="name" name="name">
                                <label for="floatingInput" name="name">admin name</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="submit" class="form-control" id="floatingInput" value="updwate">
