                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('showDepartmentEdit', ['id'=>$department->id]) }}"><i class="fas fa-pencil-alt"></i></a></td>
                                        <td><a href="{{ route('DepartmentDelete', ['id'=>$department->id]) }}"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                    </tr>
                                    @endforeach
