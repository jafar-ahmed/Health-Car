                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="floatingInput" placeholder="pass" name="pass">
                                <label for="floatingInput">admin password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="submit" class="form-control" id="floatingInput" value="add">
