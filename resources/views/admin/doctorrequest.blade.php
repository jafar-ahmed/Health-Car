                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @foreach ($adminRequest as $item)
                                    <tr>
                                        <th scope="row">{{$loop->iteration}}</th>
                                        <td>{{$item->doctorName}}</td>
                                        <td>{{$item->email}}</td>
                                        <td>{{$item->cv}}</td>
                                        <td><a href="{{ route('accesptRequest', ['id'=>$item->id]) }}"><i class="fas fa-pencil-alt"></i></a></td>
                                        <td><a href="{{ route('ReqjectRequest', ['id'=>$item->id]) }}"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                    </tr>
                                    @endforeach
