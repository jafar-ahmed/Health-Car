        ...
        <div class="sidebar pe-4 pb-3 open">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('DoctorRequest') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>request </a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>clinics </a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('addClinic') }}"  class="dropdown-item">add clinics </a>
                            <a href="{{ route('Clinic') }}"  class="dropdown-item">clinics </a>
                        </div>
                    </div>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="{{ route('doctorProfile') }}" class="dropdown-item">My Profile</a>
                            <a href="{{ route('doctorEditInfo') }}" class="dropdown-item">Edit Profile</a>
