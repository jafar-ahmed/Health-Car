        ...
        <div class="sidebar pe-4 pb-3 open">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('medicalcare') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Home</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>chronic diseases</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('diseases') }}" class="dropdown-item">show chronic diseases</a>
                            <a href="{{ route('AddDiseases') }}"  class="dropdown-item">add chronic diseases</a>
                        </div>
                    </div>

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>previose operation</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('previousOperations') }}" class="dropdown-item">show previose operation</a>
                            <a href="{{ route('Addoperation') }}"  class="dropdown-item">add previose operation</a>
                        </div>
                    </div>


                    <a href="{{ route('profile') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>profile</a>
                    <a href="{{ route('Gallary') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Gallary</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Add diseases</h6>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                                <label for="floatingInput">diseases name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                                <label for="floatingInput">diseases medic</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                                <label for="floatingInput">diseases status</label>
                            </div>
